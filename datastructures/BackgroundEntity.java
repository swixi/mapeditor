...
public class BackgroundEntity extends MapEntity
{
    ...
    public BackgroundEntity(String name, int objectX, int objectY, int objectWidth, int objectHeight)
    {
        imageName = name;
        x = objectX;
        y = objectY;
    ...
    public BackgroundEntity(BackgroundEntity mo)
    {
        this.x = mo.x;
        this.y = mo.y;
        this.width = mo.width;
